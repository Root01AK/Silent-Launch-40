      ...
      <div className="review-right">
        ...
        >
          <div style={{ background: "#f5f5f5", padding: "15px", borderRadius: "8px", textAlign: "center" }}>
            <h4>Grammar Check</h4>
            <p>Detecting grammatical errors, punctuation and structural issues</p>
          </div>
          <div style={{ background: "#f5f5f5", padding: "15px", borderRadius: "8px", textAlign: "center" }}>
            <h4>Content Score</h4>
            <p>Evaluating content quality based on coherence, clarity, tone, originality</p>
          </div>
          <div style={{ background: "#f5f5f5", padding: "15px", borderRadius: "8px", textAlign: "center" }}>
        ...
        {!approved && !rejected && (
          <div className="button-group">
            <button className="btn-accept" onClick={() => setApproved(true)}>Accept</button>
            <button className="btn-reject" onClick={() => setRejected(true)}>Reject</button>
          </div>
        )}
